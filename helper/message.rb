...
3. Input : /explore =>  response : List of all available currency---Note It\'s a  lot of data
4. Input : usd-eur(example)     =>  response : with the usd/eur exchange rate, you can use any currency of your choice
5. Input : /formular  =>  response : The calculation involve in the exchange rate
6. Input : /stop   =>  response : Send a Good bye message to user
'.freeze
